...
function handleResponse() {
    ...
    var removechart = document.getElementById("selfChart");
    while (removechart.hasChildNodes()) {
        removechart.removeChild(removechart.firstChild);
    }
    ...
    d3.json("jsonGetLettters", function(error, data){
